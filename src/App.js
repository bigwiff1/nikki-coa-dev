...
const initialCOAs = [
  ...
  },
  {
    ...
    synergies: [13], conflicts: [1, 9, 10],
  },
  {
    id: 7, category: "School · Full-Time", name: "Stanford GSB",
    status: "Not Admitted", geo: "Palo Alto / Bay Area",
    flexScore: 3, incomeScore: 1, upsideScore: 5, geoScore: 3, jackScore: 5,
    incomeNote: "N/A -- not admitted", flexNote: "N/A",
    upsideNote: "N/A", geoNote: "N/A",
    jackNote: "N/A",
    notes: "Did not receive admission. Off the board. No action required.",
    synergies: [], conflicts: [],
  },
  {
    id: 8, category: "School · Full-Time", name: "Booth (Full-Time MBA)",
    status: "Admitted -- Declined", geo: "Chicago",
    flexScore: 3, incomeScore: 1, upsideScore: 5, geoScore: 2, jackScore: 4,
    incomeNote: "Declined -- not pursuing", flexNote: "N/A",
    upsideNote: "Top-3 MBA -- not the right fit/timing", geoNote: "Chicago move not desired",
    jackNote: "N/A",
    notes: "Admitted to Booth but chose not to attend. Full-time MBA at this stage doesn't fit the COA priorities -- too much flexibility and income sacrifice. Decision is final. Off the board.",
    synergies: [], conflicts: [],
  },
  {
    id: 9, category: "School · Part-Time", name: "UCLA Anderson EMBA",
    status: "In Consideration", geo: "Los Angeles",
    flexScore: 4, incomeScore: 3, upsideScore: 4, geoScore: 4, jackScore: 3,
    incomeNote: "Maintain income alongside", flexNote: "Weekend cohort -- manageable",
    upsideNote: "Strong SoCal brand + network", geoNote: "SoCal -- LA-adjacent, near campus",
    jackNote: "Shifts toward LAX -- SAN pickup harder",
    notes: "Still in the running. Best SoCal flexibility+brand combo. Can run alongside sim job or part-time work. GI Bill applies. Key consideration vs Ross: SoCal network depth vs national brand. If staying in SoCal long-term, UCLA wins. If open to relocation, Ross may edge it.",
  ...
  {
    id: 11, category: "Geography", name: "Coronado / SD",
    status: "Exploratory", geo: "Coronado, CA",
    flexScore: 4, incomeScore: 3, upsideScore: 3, geoScore: 5, jackScore: 5,
    incomeNote: "CA tax: ~9.3-10.3% drag", flexNote: "Known area, no transition",
    upsideNote: "NAS + sim job synergy", geoNote: "NAS North Island -- sim job ideal",
    jackNote: "SAN primary -- max trip pickup",
    notes: "Natural move if sim job continues. NAS North Island proximity perfect for sim gig. Coronado itself is expensive -- North County (Encinitas, Carlsbad) more affordable. Still CA taxes. SD home at 2.25% stays as rental if you move.",
    synergies: [1, 5], conflicts: [],
  },
  {
    id: 12, category: "Geography", name: "North County SD",
    status: "Exploratory", geo: "Encinitas / Carlsbad, CA",
    flexScore: 4, incomeScore: 3, upsideScore: 3, geoScore: 4, jackScore: 5,
    incomeNote: "CA tax still applies", flexNote: "SoCal lifestyle, no big transition",
    upsideNote: "Same SD defense/tech market", geoNote: "SoCal quality of life upgrade",
    jackNote: "SAN easy, LAX trips flexible",
    notes: "More affordable than Coronado. Close enough to NAS for sim gig. Great schools, outdoor lifestyle, strong community. CA tax drag persists. Good choice if staying SD area but wanting more space for the family.",
    synergies: [1, 5], conflicts: [],
  },
  {
    id: 13, category: "Geography", name: "Orange County",
    status: "Exploratory", geo: "Orange County, CA",
    ...
    notes: "Only makes sense if OC defense tech (Anduril) is the work COA. Coronado sim commute untenable from OC. Jack shifts toward LAX which helps his commute. CA taxes remain the drag.",
    synergies: [6], conflicts: [1],
  },
  {
    id: 14, category: "Geography", name: "LA County",
    status: "Exploratory", geo: "Los Angeles County, CA",
    flexScore: 3, incomeScore: 3, upsideScore: 4, geoScore: 4, jackScore: 4,
    incomeNote: "CA tax + high COL", flexNote: "Big city -- higher cost of living",
    upsideNote: "Massive market -- tech, defense, entertainment", geoNote: "SoCal -- UCLA EMBA synergy",
    jackNote: "Live near LAX -- commute essentially zero",
    notes: "Natural fit if UCLA Anderson EMBA is the school COA -- campus is in Westwood. Jack's commute essentially disappears. CA taxes and high COL are the drag. Maximizes UCLA EMBA value through proximity to cohort, networking, and LA defense/tech scene.",
    synergies: [9, 6], conflicts: [1],
  },
  {
    id: 15, category: "Geography", name: "Jacksonville, FL",
    ...
    jackNote: "JIA to LAX is hardest FL commute",
    notes: "Strong FL financial case. No state income tax + Jack P&T = $0 property tax. Rent SD (positive cash flow at 2.25%) + rent FL first then buy. NAS Jax could open sim work for Nikki. Jack commute is the friction -- JIA to LAX is a grind.",
    synergies: [2], conflicts: [1, 5, 6, 9],
  },
  {
    id: 16, category: "Geography", name: "Tampa / St. Pete, FL",
    ...
    upsideNote: "MacDill AFB -- SOCOM/CENTCOM/SOUTHCOM contractor", geoNote: "Great lifestyle, far from SoCal",
    jackNote: "TPA-MCO co-base -- two home airports, LAX solved",
    notes: "Same FL tax advantages as Jax but Jack ops work cleanly -- TPA-MCO co-base means two home airports, solid LAX direct service from both. MacDill = SOCOM/CENTCOM/SOUTHCOM -- aviation/acquisitions background fits. Rent SD + rent FL first then buy = strong dual-asset play.",
    synergies: [2], conflicts: [1, 9],
  },
  {
    id: 17, category: "Geography", name: "Denver, CO",
    status: "Exploratory", geo: "Denver, CO",
    flexScore: 3, incomeScore: 4, upsideScore: 4, geoScore: 2, jackScore: 3,
    incomeNote: "CO flat tax ~4.4% -- much better than CA, worse than FL", flexNote: "New city -- exceptional outdoor lifestyle",
    upsideNote: "Lockheed, Raytheon, Space Force (Buckley/Peterson/Schriever)", geoNote: "Far from SoCal network -- different vibe",
    jackNote: "DEN to LAX decent but no co-base advantage",
    notes: "Colorado flat income tax ~4.4% -- significant improvement over CA's 9.3-10.3% but not zero like FL. No full P&T property tax exemption in CO (partial only). Strong defense/aerospace: Lockheed Martin, Raytheon, Space Force bases, Boeing. Exceptional outdoor lifestyle -- great for family. Jack commutes DEN-LAX with plenty of flights but no co-base optimization. Net: financially better than CA, worse than FL.",
    synergies: [2, 4], conflicts: [1, 9],
  },
];
...
const NODES = [
  ...
  // FINANCE
  {
    ...
    monthId: "apr",
    label: "Zoe Starts\nLearning Jungle",
    sublabel: "$1,302/wk both kids\n~$5,644/mo — sim job covers it",
    color: "#14532d",
    border: "#4ade80",
    width: 130,
  },
  ...
  },
  {
    ...
    monthId: "may",
    label: "Model July\nIncome Cliff",
    sublabel: "Mil pay+BAH gone\nChildcare ~$5,644/mo kicks in",
    color: "#14532d",
    border: "#4ade80",
    width: 120,
  },
